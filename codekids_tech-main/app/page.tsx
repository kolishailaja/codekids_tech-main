...
// Stat Card Component
function StatCard({ feature, index }: { feature: typeof features[0], index: number }) {
  const [hasAnimated, setHasAnimated] = useState(false);
  const counter = useCounter(feature.value, 2000, hasAnimated, feature.isDecimal);
  ...
  return (
    ...
    >
      <GlassCard className="p-6 sm:p-8 h-full hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl border border-border/50 hover:border-primary/40 bg-white/50 dark:bg-secondary/50 backdrop-blur-sm relative overflow-hidden">
        ...
        <motion.div
          ...
          className="mb-2"
        >
          <div className={`text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r ${feature.color} bg-clip-text text-transparent`}>
            {feature.isDecimal ? counter.toFixed(1) : counter.toLocaleString()}{feature.suffix}
          </div>
        </motion.div>
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[85vh] sm:h-[90vh] min-h-[600px] sm:min-h-[700px] overflow-hidden pt-20 md:pt-0">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {/* Background Image using Next.js Image for proper loading */}
            <Image
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold mb-3 sm:mb-4 md:mb-6 font-heading leading-tight">
                  ...
                  {heroSlides[currentSlide].subDescription && (
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/85 leading-relaxed max-w-4xl mb-2">
                      {heroSlides[currentSlide].subDescription}
                    </p>
                  )}
                  ...
                  {heroSlides[currentSlide].tagline && !heroSlides[currentSlide].features && (
                    <p className="text-base sm:text-lg md:text-xl text-white/90 font-semibold max-w-4xl mb-3 sm:mb-4">
                      {heroSlides[currentSlide].tagline}
                    </p>
                  )}

                  {heroSlides[currentSlide].description2 && (
                    <p className="text-sm sm:text-base md:text-lg text-white/85 leading-relaxed max-w-4xl mt-2 mb-3 sm:mb-4">
                      {heroSlides[currentSlide].description2}
                    </p>
                  )}
                  ...
                  {heroSlides[currentSlide].tagline && heroSlides[currentSlide].features && (
                    <p className="text-base sm:text-lg md:text-xl text-white font-semibold max-w-4xl mt-3 sm:mt-4">
                      {heroSlides[currentSlide].tagline}
                    </p>
                  )}
                </motion.div>
              ...
              >
                {heroSlides[currentSlide].ctaButtons ? (
                  heroSlides[currentSlide].ctaButtons.map((button, index) => {
                    ...
                    const Component = isPdfDownload ? 'a' : Link;
                    const linkProps = isPdfDownload 
                      ? { href: button.href, download: true }
                      : { href: button.href };
                    ...
                    return (
                      <Component
                        ...
                        className={`inline-flex items-center justify-center gap-2 px-4 py-3.5 sm:px-6 sm:py-3 md:px-8 md:py-4 rounded-full font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all text-xs sm:text-sm md:text-base w-full sm:w-auto min-h-[48px] touch-manipulation ${
                  ...
                  <>
                    <Link
                      href="/codekids-jr"
                      className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all text-sm md:text-base"
                    >
                      Explore Programs
                      <PlayCircle className="h-5 w-5" />
                    </Link>
                    <Link
                      href="/codekids-jr"
                      className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-full border-2 border-white text-white font-semibold hover:bg-white hover:text-purple-900 transition-all text-sm md:text-base"
                    >
                      Learn More
                      <ArrowRight className="h-5 w-5" />
                    </Link>
      ...
      <section className="py-20 bg-gradient-to-b from-transparent via-purple-50/20 dark:via-purple-950/10 to-secondary/20 relative overflow-hidden">
      ...
      <section className="py-20 sm:py-24 bg-gradient-to-b from-secondary/10 via-transparent to-secondary/10 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 mb-6 border border-primary/20">
            ...
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 mb-12">
            {[
              ...
              >
                <GlassCard className="p-5 sm:p-6 md:p-7 min-h-[140px] sm:min-h-[160px] flex flex-col hover:scale-105 transition-transform duration-300 border border-border/50 hover:border-primary/30 h-full">
          ...
          >
            <GlassCard className="p-6 sm:p-8 md:p-10 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 border-2 border-primary/30">
              <div className="text-center">
                ...
                <p className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
          ...
          >
            <div className="text-center mb-8 sm:mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 mb-4 border border-primary/20">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 font-heading">
                🟦 🎓 <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">OUR SIGNATURE COMBO COURSES</span>
              </h3>
            ...
            <div className="flex justify-center">
              <Link
                href="/codekids-pro#combined-courses"
                prefetch={true}
                onClick={(e) => {
                ...
                className="inline-flex items-center gap-2 px-6 py-3 sm:px-8 sm:py-4 rounded-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all"
              >
            ...
            {programs.map((program, index) => (
              ...
              >
                <GlassCard className="overflow-hidden h-full hover:scale-105 transition-transform duration-300 shadow-xl">
                  <div className={`relative h-48 sm:h-56 md:h-64 overflow-hidden group-hover:scale-110 transition-transform duration-700`}>
                    {/* Background Image */}
                    {program.image && (
                      <Image
                        src={program.image}
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 text-white z-10">
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 font-heading drop-shadow-lg">{program.title}</h3>
                  ...
                  <div className="p-5 sm:p-6 md:p-8 bg-gradient-to-b from-secondary/50 to-secondary/30">
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-b from-secondary/20 via-primary/5 to-secondary/20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 font-heading text-foreground">
              Download Our <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">Brochures</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4">
              Explore our comprehensive programs and discover how CodeKids can transform your learning journey or enhance your school&apos;s technology education.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            ...
            >
              <GlassCard className="p-6 sm:p-8 h-full hover:scale-105 transition-transform duration-300 border-2 border-pink-500/20 hover:border-pink-500/40 bg-gradient-to-br from-pink-500/5 to-rose-500/5">
                <div className="flex flex-col items-center text-center">
                  ...
                  <a
                    ...
                    download
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:px-8 sm:py-4 rounded-full bg-gradient-to-r from-pink-500 to-rose-500 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all w-full min-h-[48px] touch-manipulation"
                  >
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <GlassCard className="p-6 sm:p-8 h-full hover:scale-105 transition-transform duration-300 border-2 border-purple-500/20 hover:border-purple-500/40 bg-gradient-to-br from-purple-500/5 to-indigo-500/5">
                <div className="flex flex-col items-center text-center">
                  ...
                  <a
                    ...
                    download
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:px-8 sm:py-4 rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all w-full min-h-[48px] touch-manipulation"
                  >
                    <Download className="h-5 w-5" />
      ...
      {/* Learning in Action */}
      <section className="py-20 bg-gradient-to-b from-transparent via-purple-50/30 dark:via-purple-950/20 to-transparent relative overflow-hidden">
        {/* Background Decorative Elements */}
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-pink-500/20 to-purple-500/20 rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-purple-500/20 to-cyan-500/20 rounded-full blur-3xl" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              >
                <GlassCard className="relative h-[250px] sm:h-[280px] md:h-[300px] overflow-hidden rounded-2xl border-2 border-transparent hover:border-primary/30 transition-all duration-500 cursor-pointer">
                  {/* Image */}
                  <div className="absolute inset-0">
                    <Image
                      src={item.image}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                className="group"
              >
                <GlassCard className="p-4 sm:p-5 md:p-6 h-full hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl border border-border/50 hover:border-primary/30">
          ...
          >
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
                Meet the visionary academic leader transforming technology education in India
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
                  ...
                  >
                    ...
                    <div className="relative h-[500px] md:h-[600px] w-full rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10 dark:border-white/5">
                      ...
                      <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="absolute top-8 right-8 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/90 to-purple-500/90 backdrop-blur-md border border-white/30 shadow-xl"
                      >
                        <span className="text-sm font-bold text-white">Founder & CEO</span>
                      </motion.div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-lg text-muted-foreground mb-4">Founder & Chief Executive Officer</p>
                      <div className="flex flex-wrap gap-2 mb-6">
                        <span className="px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 text-sm font-semibold border border-blue-500/20">
                          Academic Leader
                        </span>
                        <span className="px-3 py-1 rounded-full bg-purple-500/10 text-purple-600 dark:text-purple-400 text-sm font-semibold border border-purple-500/20">
                          Researcher
                        </span>
                        <span className="px-3 py-1 rounded-full bg-pink-500/10 text-pink-600 dark:text-pink-400 text-sm font-semibold border border-pink-500/20">
                          Innovator
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 text-muted-foreground leading-relaxed">
                      <p>
                        Dr. D. N. Reddy is a distinguished academician and technology education pioneer with decades of experience in transforming how students learn and apply technology. With a strong foundation in computer science and education, Dr. Reddy has dedicated his career to making cutting-edge technology education accessible to students across India.
                      </p>
                      <p>
                        Under his leadership, CodeKids Technologies has grown into a comprehensive EdTech ecosystem, serving thousands of students and partnering with leading educational institutions. His vision combines international academic standards with hands-on, project-based learning to prepare students for the future of work.
                      </p>
                      <p>
                        Dr. Reddy&apos;s commitment to innovation and excellence drives CodeKids&apos; mission to build a generation of tech-savvy, problem-solving innovators ready to shape tomorrow&apos;s world.
                      </p>
                    </div>
                  </motion.div>
                </div>
