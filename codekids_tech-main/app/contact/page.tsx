  ...
  return (
    <div className="min-h-screen py-20 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 className="text-foreground text-5xl md:text-6xl font-bold mb-6 font-heading">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@codekids.in" className="text-muted-foreground hover:text-primary transition-colors">
                        info@codekids.in
                      </a>
                    </div>
                  </div>
