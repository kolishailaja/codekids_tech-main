...
import { 
  Rocket, Sparkles, Trophy, Users, BookOpen, Lightbulb, Star, ChevronDown, 
...
export default function CodeKidsJrPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="relative z-10 p-12 md:p-16 lg:p-20 text-center text-white">
              ...
              >
                <Link
                  href="/contact?type=offline-school-program"
            ...
            >
              ...
              <GlassCard className="p-8 bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-blue-500/10 border-2 border-primary/30">
                <div className="text-center">
                  ...
                  <Link
                    href="/contact?type=online-class"
                ...
                >
                  <GlassCard className="h-full overflow-hidden hover:scale-105 transition-transform duration-300 border-2 border-transparent hover:border-primary/30">
                    ...
                    <div className="p-6">
                      ...
                      {/* CTA Button */}
                      <Link
                        href={`/contact?type=online-class&program=${encodeURIComponent(program.title)}`}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeInUp} className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Hear from students who are building their future with CodeKids
            </p>
          </motion.div>
      ...
      {/* Demo Form */}
      <section id="jr-demo-form" className="py-20 bg-gradient-to-b from-transparent to-secondary/20">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeInUp}>
            <GlassCard className="p-8">
              <h2 className="text-foreground text-3xl font-bold mb-2 font-heading text-center">
                Request a <span className="bg-gradient-to-r from-[#FF4B8F] via-[#7B3DFF] to-[#2ED0FF] bg-clip-text text-transparent">School Demo</span>
              </h2>
